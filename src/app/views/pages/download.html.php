...
<section class="py-5">
    <div class="container px-5 my-5">
        <div class="text-center mt-5">
            <h1 class="fw-bolder">Download</h1>
            <p class="lead fw-normal text-muted mb-0">Enter the key of the file to download</p>
        </div>

        <form class="container form-inline" action="/download" method="POST">
            <div class="input-group mb-3 mt-4 mr-sm-2">
                <div class="input-group-prepend">
                    <div class="input-group-text"><i class="bi bi-key"></i></div>
                </div>
                <input type="text" class="form-control" name="key" placeholder="Enter a key...">
            </div>
